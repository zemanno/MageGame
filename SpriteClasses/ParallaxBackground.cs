    ...
    public class ParallaxBackground
    {
        ...
        public void Draw()
        {
            ...
            for (int i = 0; i < layerList.Count; i++)
            {
                ...
                {
                    //draw1 - always done
                    batch.Draw(layerList[i].Image, new Vector2(layerList[i].position.X, 0.0f) + layerList[i].Offset, layerList[i].Color);
                    ...
                    {
                        batch.Draw(layerList[i].Image, new Vector2(layerList[i].position.X - layerList[i].ImageSize.X, 0.0f) + layerList[i].Offset, layerList[i].Color);
                    }
                ...
                {
                    //draw1 - always done
                    batch.Draw(layerList[i].Image, new Vector2(0.0f, layerList[i].position.Y) + layerList[i].Offset, layerList[i].Color);
                    //draw2 - done only when image moving off screen
                    ...
                    if (layerList[i].position.Y > 0.0f)
                    {
                        ...
                        batch.Draw(layerList[i].Image, new Vector2(0.0f, layerList[i].position.Y - layerList[i].ImageSize.Y) + layerList[i].Offset, layerList[i].Color);
                    }
